...
function showFinishedText() {
    ...
    var style = { font: "40px Arial", fill: Koji.config.colors.textColor, align: "center"};

    var text = game.add.text(game.world.centerX, game.world.centerY, Koji.config.strings.content, style);
